...
SELECT pg_catalog.setval('public.guesses_guess_id_seq', 3869, true);
...
ALTER TABLE ONLY public.guesses
    ADD CONSTRAINT guesses_game_id_fkey FOREIGN KEY (game_id) REFERENCES public.games(game_id) ON DELETE CASCADE;
