...
--
-- Name: customers_costumer_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--
...
ALTER TABLE public.customers_costumer_id_seq OWNER TO freecodecamp;

--
-- Name: customers_costumer_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--
...
INSERT INTO public.customers VALUES (88, '555-555-5555', 'Fabio');
...
--
-- Name: customers_costumer_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.customers_costumer_id_seq', 108, true);
